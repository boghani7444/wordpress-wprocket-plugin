...
define( 'WP_ROCKET_PRIVATE_KEY'         , '0d39d8d5a3275938fc899df9cae7e12d');
define( 'WP_ROCKET_SLUG'                , 'wp_rocket_settings' );
define( 'WP_ROCKET_WEB_MAIN'            , '' );
define( 'WP_ROCKET_WEB_API'             , '' );
define( 'WP_ROCKET_WEB_CHECK'           , '' );
define( 'WP_ROCKET_WEB_VALID'           , '' );
define( 'WP_ROCKET_WEB_INFO'            , '' );
define( 'WP_ROCKET_WEB_SUPPORT'         , '' );
